document.addEventListener('DOMContentLoaded', () => {
    const items = document.querySelectorAll('.media-card__bottom--rs');
    ...
    items.forEach(group => {
        ...
        const like = group.querySelector('.media-card__feedback-button[data-action="like"]');

        const likeValue = like.querySelector('.media-card__feedback-button-value');
